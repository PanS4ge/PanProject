#me_and_the_boys - Generate Me And The Boys meme with 2 boxes.
import discord
import requests
import json
username = "rng31323"
...
async def Cmd(language, serverlang, message, client):
   ...
   params = {
       ...
       'text0': str(message.content).replace(useprefix + "me_and_the_boys", "").split('||')[0],
       'text1': str(message.content).replace(useprefix + "me_and_the_boys", "").split('||')[1],
   }
