#marvel_civil_war_1 - Generate Marvel Civil War 1 meme with 2 boxes.
import discord
import requests
import json
username = "rng31323"
...
async def Cmd(language, serverlang, message, client):
   ...
   params = {
       ...
       'text0': str(message.content).replace(useprefix + "marvel_civil_war_1", "").split('||')[0],
       'text1': str(message.content).replace(useprefix + "marvel_civil_war_1", "").split('||')[1],
   }
