#im_the_captain_now - Generate I'm The Captain Now meme with 2 boxes.
import discord
import requests
import json
username = "rng31323"
...
async def Cmd(language, serverlang, message, client):
   ...
   params = {
       ...
       'text0': str(message.content).replace(useprefix + "im_the_captain_now", "").split('||')[0],
       'text1': str(message.content).replace(useprefix + "im_the_captain_now", "").split('||')[1],
   }
