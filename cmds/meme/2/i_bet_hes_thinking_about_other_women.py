#i_bet_hes_thinking_about_other_women - Generate I Bet He's Thinking About Other Women meme with 2 boxes.
import discord
import requests
import json
username = "rng31323"
...
async def Cmd(language, serverlang, message, client):
   ...
   params = {
       ...
       'text0': str(message.content).replace(useprefix + "i_bet_hes_thinking_about_other_women", "").split('||')[0],
       'text1': str(message.content).replace(useprefix + "i_bet_hes_thinking_about_other_women", "").split('||')[1],
   }
