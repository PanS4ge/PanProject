#uno_draw_25_cards - Generate UNO Draw 25 Cards meme with 2 boxes.
import discord
import requests
import json
username = "rng31323"
...
async def Cmd(language, serverlang, message, client):
   ...
   params = {
       ...
       'text0': str(message.content).replace(useprefix + "uno_draw_25_cards", "").split('||')[0],
       'text1': str(message.content).replace(useprefix + "uno_draw_25_cards", "").split('||')[1],
   }
