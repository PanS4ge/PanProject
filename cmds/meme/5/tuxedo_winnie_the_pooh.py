#tuxedo_winnie_the_pooh - Generate Tuxedo Winnie The Pooh meme with 2 boxes.
import discord
import requests
import json
username = "rng31323"
...
async def Cmd(language, serverlang, message, client):
   ...
   params = {
       ...
       'text0': str(message.content).replace(useprefix + "tuxedo_winnie_the_pooh", "").split('||')[0],
       'text1': str(message.content).replace(useprefix + "tuxedo_winnie_the_pooh", "").split('||')[1],
   }
