#yo_dawg_heard_you - Generate Yo Dawg Heard You meme with 2 boxes.
import discord
import requests
import json
username = "rng31323"
...
async def Cmd(language, serverlang, message, client):
   ...
   params = {
       ...
       'text0': str(message.content).replace(useprefix + "yo_dawg_heard_you", "").split('||')[0],
       'text1': str(message.content).replace(useprefix + "yo_dawg_heard_you", "").split('||')[1],
   }
