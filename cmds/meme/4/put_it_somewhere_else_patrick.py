#put_it_somewhere_else_patrick - Generate Put It Somewhere Else Patrick meme with 2 boxes.
import discord
import requests
import json
username = "rng31323"
...
async def Cmd(language, serverlang, message, client):
   ...
   params = {
       ...
       'text0': str(message.content).replace(useprefix + "put_it_somewhere_else_patrick", "").split('||')[0],
       'text1': str(message.content).replace(useprefix + "put_it_somewhere_else_patrick", "").split('||')[1],
   }
