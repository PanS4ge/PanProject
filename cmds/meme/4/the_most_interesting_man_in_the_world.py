#the_most_interesting_man_in_the_world - Generate The Most Interesting Man In The World meme with 2 boxes.
import discord
import requests
import json
username = "rng31323"
...
async def Cmd(language, serverlang, message, client):
   ...
   params = {
       ...
       'text0': str(message.content).replace(useprefix + "the_most_interesting_man_in_the_world", "").split('||')[0],
       'text1': str(message.content).replace(useprefix + "the_most_interesting_man_in_the_world", "").split('||')[1],
   }
