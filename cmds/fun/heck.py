#{}heck (what to heck), (who to heck) - :flushed: (alt. arg > get_pass, get_email, rem_dc_acc)
import os
import discord
import time
import asyncio
...
async def Cmd(language, serverlang, message, client):
    try:
        ...
        msgheck = await message.channel.send("<a:loading:936978619639668787> Calling hecker... Please wait...")
        await asyncio.sleep(random.randint(1, 10))
        await msgheck.edit(content="<a:loading:936978619639668787> Hecker got it, starting heck...")
        await asyncio.sleep(3)
        await msgheck.edit(content=f"<a:loading:936978619639668787> Setting target: {message.content.split(' ')[2]}'s {message.content.split(' ')[1]}")
        await asyncio.sleep(random.randint(5, 10))
        await msgheck.edit(content=f"<a:loading:936978619639668787> Target locked")
        await asyncio.sleep(random.randint(100, 1012) / 100)
        await msgheck.edit(content=f"<a:loading:936978619639668787> Brute-forcing {message.content.split(' ')[2]}'s {message.content.split(' ')[1]}")
        await asyncio.sleep(random.randint(100, 1012) / 100)
        await msgheck.edit(content=f"<a:loading:936978619639668787> Freezing {message.content.split(' ')[2]}'s {message.content.split(' ')[1]}")
        await asyncio.sleep(random.randint(100, 1012) / 100)
        await msgheck.edit(content=f"<a:loading:936978619639668787> Sending nukes on {message.content.split(' ')[2]}'s {message.content.split(' ')[1]}")
        await asyncio.sleep(random.randint(100, 1012) / 100)
        await msgheck.edit(content=f"<a:loading:936978619639668787> Checking {message.content.split(' ')[2]}'s browsing history")
        await asyncio.sleep(random.randint(100, 1012) / 100)
        await msgheck.edit(content=f"<a:loading:936978619639668787> Checking {message.content.split(' ')[2]}'s browsing history\nFound:\n{random.randint(2, 1135)} sus websites")
        await asyncio.sleep(random.randint(100, 1012) / 100)
        await msgheck.edit(content=f"<a:loading:936978619639668787> Checking {message.content.split(' ')[2]}'s browsing history\nFound:\n{random.randint(2, 1135)} very sus websites")
        await asyncio.sleep(random.randint(100, 1012) / 100)
        await msgheck.edit(content=f"<a:loading:936978619639668787> Reporting {message.content.split(' ')[2]}'s death to his parents...")
        await asyncio.sleep(random.randint(100, 1012) / 100)
        await msgheck.edit(content=f"<a:loading:936978619639668787> Updating {message.content.split(' ')[2]} social status")
        await asyncio.sleep(random.randint(100, 1012) / 100)
        await msgheck.edit(content=f"<a:loading:936978619639668787> Stealing {message.content.split(' ')[2]}'s {random.randint(1, 50 * len(message.content.split(' ')[2]))} social points")
        await asyncio.sleep(random.randint(100, 1012) / 100)
        try:
